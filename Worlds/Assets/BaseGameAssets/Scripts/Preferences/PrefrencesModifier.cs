...
namespace Worlds.Saves
{
    public class PrefrencesModifier : MonoBehaviour
    {
        ...
        private void SetupAmPmToggler()
        {
            amPMToggle.isOn = PreferencesManager.current_prefs.usingAMPM;

            amPMToggle.onValueChanged.AddListener((bool val) =>
            {
                PreferencesManager.current_prefs.usingAMPM = val;
                LoadInPrefs(PreferencesManager.current_prefs);
            });
        }
        ...
        public void LoadInPrefs(PreferencesManager.Preferences preferences)
        {
            ...
            DayNight.TimeKeeper.amPM = preferences.usingAMPM;
